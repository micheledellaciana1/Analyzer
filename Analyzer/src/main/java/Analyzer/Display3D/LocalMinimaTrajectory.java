...
import Analyzer.Fit.LocalMinima;
import Analyzer.Fit.PeakFinder;

public class LocalMinimaTrajectory extends Analysis {

    public LocalMinimaTrajectory() {
        super("LocalMinimaTrajectory");
    }
    ...
    public ArrayList<double[][]> getAnalysis(XYSeriesCollection series, String args) {
        ...
        PeakFinder peakFinder = LocalMinima.instance;
